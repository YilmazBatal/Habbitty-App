...
class _MyAppState extends State<MyApp> {
                          ...
                          children: [
                            UncheckedActivity(
                                ...
                                Icon(Icons.fitness_center,
                                    size: 55, color: navyBlue)),
                            CheckedActivity(darkGreen, lightGreen,
                                "10 Push Ups", "10:00 AM - 10:15 AM"),
                            UncheckedActivity(
                                navyBlue,
                                "10 Push Ups",
                                "10:00 AM - 10:15 AM",
  ...
  Padding CheckedActivity(Color darkGreen, Color lightGreen,
  ...
  Padding UncheckedActivity(Color navyBlue, String activityName,
      String activityTime, Icon activityIcon) {
    return Padding(
      padding: const EdgeInsets.symmetric(vertical: 8.0),
      child: Row(
        children: [
  ...
  Expanded HabbittyBox(double boxHeight, Color boxShadowColor, Color boxColor,
      Color boxColor2, Center myChild) {
    return Expanded(
      child: Container(
        height: boxHeight,
        width: 200,
